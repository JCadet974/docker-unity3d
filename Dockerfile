...
# JC Unity-Hub : https://public-cdn.cloud.unity3d.com/hub/prod/UnityHub.AppImage?button=onboarding-download-btn-linux&_ga=2.173720483.14251061.1616960601-1327513681.1616960601
# JC IMAGE sur le disque : 'UnityHub.AppImage?button=onboarding-download-btn-linux'
...
RUN mkdir -p /home/adminuser/.cache/unity3d && mkdir -p /home/adminuser/.local/share/unity3d/Unity && \
 ...
 && \
  dpkg -i 'UnityHub.AppImage?button=onboarding-download-btn-linux' && \
